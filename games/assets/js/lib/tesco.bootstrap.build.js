 ...
 * Build: http://modernizr.com/download/#-csstransforms-csstransforms3d-csstransitions-touch-printshiv-cssclasses-teststyles-testprop-testallprops-prefixes-domprefixes
 */
...
/* Protect window.console method calls, eg for IE8 */
(function () {
  var x, aMethods, iNumberOfMethods;
  if (!window.console || typeof window.console === 'undefined') {
    window.console = {};
    aMethods = ['log', 'info', 'warn', 'error', 'debug', 'trace', 'dir', 'group', 'groupCollapsed', 'groupEnd', 'time', 'timeEnd', 'profile', 'profileEnd', 'dirxml', 'assert', 'count', 'markTimeline', 'timeStamp', 'clear']; // all console methods for IE, FF, Chrome and Safari
    iNumberOfMethods = aMethods.length;
    for (x = 0; x < iNumberOfMethods; x++) {
      if (!window.console[aMethods[x]]) {
        window.console[aMethods[x]] = function () {
          return;
        };
      }
    }
